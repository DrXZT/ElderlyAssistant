...
public class Food1PorkGarlicActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_back:
                Intent intent1 = new Intent(Food1PorkGarlicActivity.this,FoodActivity.class);
