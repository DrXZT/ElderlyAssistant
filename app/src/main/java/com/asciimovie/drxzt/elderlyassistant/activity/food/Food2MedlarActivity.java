...
public class Food2MedlarActivity extends AppCompatActivity implements View.OnClickListener{
    Button button1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food2_medlar);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_back:
                Intent intent1 = new Intent(Food2MedlarActivity.this,FoodActivity.class);
