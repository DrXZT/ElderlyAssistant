...
public class Food1LiverSpinachActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_back:
                Intent intent1 = new Intent(Food1LiverSpinachActivity.this,FoodActivity.class);
