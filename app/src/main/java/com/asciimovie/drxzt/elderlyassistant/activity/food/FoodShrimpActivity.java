...
public class FoodShrimpActivity extends AppCompatActivity implements View.OnClickListener {
    Button button1;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_back:
                Intent intent1 = new Intent(FoodShrimpActivity.this,FoodActivity.class);
